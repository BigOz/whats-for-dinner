...
# The image size.
# If one alters this number, then the entire model architecture will changed
# and any model would need to be retrained.
IMAGE_SIZE = 32
...
def distorted_inputs():
  ...
  read_input = nn_input.read_nn(filename_queue)
...
'''
  This section outlines the actual structure of the neural network
'''
