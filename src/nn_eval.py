...
tf.app.flags.DEFINE_string('eval_dir', '/home/olson4/workspace/project/whats-for-dinner/nn/nn_eval',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'test',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', '/home/olson4/workspace/project/whats-for-dinner/train/nn_train',
...
def eval_once(saver, summary_writer, top_k_op, summary_op):
  ...
  with tf.Session() as sess:
    ...
    if ckpt and ckpt.model_checkpoint_path:
      ...
      #   /my-favorite-path/nn_train/model.ckpt-0,
